    ...
    return (
        <header>
            <div className="wrapper header">
                <a href="#" className="logo">Yummytreats</a>
                <svg height="32px" id="menu-btn" className="open" viewBox="0 0 32 32" onClick={() => toggleNav()}>
                ...
                <nav className={`nav--container ${showNav ? 'open--nav' : ''}`}>
                    ...
                    <div className="nav--links">
                        ...
                        <a href="cart" className="nav--link">
                            <i className="ri-shopping-cart-2-line shopping--cart"></i>
                        </a>
                    </div>
                </nav>
            </div>
